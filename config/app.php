...
return [
    ...
    */
    ...
    |
    */
    'url' => env('APP_URL', 'http://localhost:8000/sowerphp-project'),
    ...
    */
    'ui' => [
        ...
        'layout' => env('APP_UI_LAYOUT', 'bootstrap'),
        ...
        'pagination' => [
            'registers' => env('APP_UI_PAGINATION_REGISTERS', 10),
        ],
        ...
        'view_engines' => [
            '.html.twig' => \sowerphp\core\View_Engine_Twig::class,
            '.md' => \sowerphp\core\View_Engine_Markdown::class,
            '.php' => \sowerphp\core\View_Engine_Php::class,
        ],
    ],
